...
public class CMLAssert {
	...
	public static void assertEquals(String msg, CMLArray test,
		...
		if ((test.getDataType() == null || test.getDataType()
			...
			JumboTestUtils.assertEquals(msg, test.getDoubles(), expected.getDoubles(), epsilon);
	...
	public static void assertEquals(String msg, double[] test,
		...
		JumboTestUtils.assertEquals(msg, test, expected.getDoubles(), epsilon);
	}
	...
	public static void assertEqualsConcise(String message, CMLFormula formula1,
		...
		if (formula1 == null) {
			Assert.fail(JumboTestUtils.getAssertFormat(message, "formula", "null"));
		}
		if (formula2 == null) {
			Assert.fail(JumboTestUtils.getAssertFormat(message, "formula", "null"));
		}
	...
	public static void assertEquals(String msg, CMLCellParameter test,
		...
		Assert.assertNotNull("expected should not be null (" + msg + CMLConstants.S_RBRAK,
				expected);
		JumboTestUtils.assertEquals(msg, test.getXMLContent(), expected.getXMLContent(),
				epsilon);
	}
	...
	public static void assertEquals(String msg, String type, double[] test,
		...
		JumboTestUtils.assertEquals(msg, test, expected.getXMLContent(), epsilon);
	}
	...
	public static void assertEquals(String msg, CMLLine3 test,
		...
		Assert.assertNotNull("expected should not be null (" + msg + CMLConstants.S_RBRAK,
				expected);
		JumboTestUtils.assertEquals(msg, test.getEuclidLine3(), expected.getEuclidLine3(),
				epsilon);
	}
	...
	public static void assertEquals(String msg, CMLPoint3 testPoint,
		...
		Assert.assertNotNull("expected should not be null (" + msg + CMLConstants.S_RBRAK,
				expected);
		JumboTestUtils.assertEquals(msg, testVector.getEuclidVector3(), new Vector3(expected
				.getVector3()), epsilon);
		JumboTestUtils.assertEquals(msg, testPoint.getEuclidPoint3(), new Point3(expected
				.getPoint3()), epsilon);
	}
	...
	public static void assertEquals(String msg, CMLMatrix test,
		...
		if (test.getEuclidRealMatrix() != null) {
			JumboTestUtils.assertEquals(msg, test.getEuclidRealMatrix(), expected
	...
	public static void assertEquals(String msg, int rows, int cols,
		...
		JumboTestUtils.assertEquals(msg, rows, cols, test, expected.getEuclidRealMatrix(),
				epsilon);
	}
	...
	public static void assertEquals(String msg, int rows, int cols, int[] test,
		...
		Assert.assertEquals("rows ", rows, expected.getRows());
		Assert.assertEquals("columns ", cols, expected.getColumns());
		JumboTestUtils.assertEquals(msg, rows, cols, test, expected.getEuclidIntMatrix());
	}
	...
	public static void assertEquals(String msg, CMLPoint3 test,
		...
		Assert.assertNotNull("expected should not be null (" + msg + CMLConstants.S_RBRAK,
				expected);
		JumboTestUtils.assertEquals(msg, test.getXYZ3(), expected.getXYZ3(), epsilon);
	}
	...
	public static void assertEquals(String msg, double[] test,
		...
		Assert.assertNotNull("expected should not be null (" + msg + CMLConstants.S_RBRAK,
				expected);
		JumboTestUtils.assertEquals(msg, test, expected.getXYZ3(), epsilon);
	}
	...
	public static void assertEquals(String msg, CMLTransform3 test,
		...
		Assert.assertNotNull("expected should not be null (" + msg + CMLConstants.S_RBRAK,
				expected);
		JumboTestUtils.assertEquals(msg, test.getEuclidTransform3(), expected
	...
	public static void assertEquals(String msg, double[] test,
		...
		Assert.assertNotNull("expected should not be null (" + msg + CMLConstants.S_RBRAK,
				expected);
		JumboTestUtils.assertEquals(msg, test, expected.getEuclidTransform3(), epsilon);
	}
